...
public class NearestSmallerElementOnRight {
  ...
  public static void main(String[] args) {
    ...
    TestCaseArray[] TestCases = {
        ...
        new TestCaseArray(new int[] { 3, 2, 5, 4, 7, 6, 9, 8, 11, 10 },
            new int[] { 2, -1, 4, -1, 6, -1, 8, -1, 10, -1 }),

        new TestCaseArray(new int[] { 2, 1 }, new int[] { 1, -1 }),
        new TestCaseArray(new int[] { 3, 2, 1 }, new int[] { 2, 1, -1 }),
        new TestCaseArray(new int[] { 4, 3, 2, 1 }, new int[] { 3, 2, 1, -1 }),
    };

    int count = 1;
    for (TestCaseArray testCase : TestCases) {
      int[] expected = testCase.R_Array;
      int[] result = findRightSmallestElement(testCase.A);
  ...
  public static int[] findRightSmallestElement(int[] A) {
    int n = A.length;
    int[] R = new int[n];
    if (n == 0) {
      return R;
