...
public class MaxHeapSort {
  static TestCaseArray[] TestCases = {
      ...
      new TestCaseArray(new int[] { 4, 3, 2, 1 }, new int[] { 1, 2, 3, 4 }),
      new TestCaseArray(new int[] { 5, 4, 3, 2, 1 }, new int[] { 1, 2, 3, 4, 5 }),
      new TestCaseArray(new int[] { 6, 5, 4, 3, 2, 1 }, new int[] { 1, 2, 3, 4, 5, 6 }),
      new TestCaseArray(new int[] { 7, 6, 5, 4, 3, 2, 1 }, new int[] { 1, 2, 3, 4, 5, 6, 7 }),
      new TestCaseArray(new int[] { 17, 15, 13, 9, 1, 5, 10, 4, 8, 3, 6 },
          new int[] { 1, 3, 4, 5, 6, 8, 9, 10, 13, 15, 17 }),
  };
  ...
  public static void main(String[] args) {
    ...
    for (TestCaseArray testCase : TestCases) {
      ...
      int[] result = buildMaxHeapSort(testCase.A);
  ...
  public static int[] buildMaxHeapSort(int[] A) {
    int n = A.length;
    if (n == 0) {
      return new int[] {};
    }
