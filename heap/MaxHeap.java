...
public class MaxHeap {
  static TestCaseArray[] TestCases = {
      ...
      new TestCaseArray(new int[] { 1, 2, 3, 4, 5 }, new int[] { 5, 4, 3, 1, 2 }),
      new TestCaseArray(new int[] { 1, 2, 3, 4, 5, 6 }, new int[] { 6, 5, 3, 4, 2, 1 }),
      new TestCaseArray(new int[] { 1, 2, 3, 4, 5, 6, 7 }, new int[] { 7, 5, 6, 4, 2, 1, 3 }),
      new TestCaseArray(new int[] { 2, 1 }, new int[] { 2, 1 }),
      new TestCaseArray(new int[] { 3, 2, 1 }, new int[] { 3, 2, 1 }),

      new TestCaseArray(new int[] { 4, 3, 2, 1 }, new int[] { 4, 3, 2, 1 }),
      new TestCaseArray(new int[] { 5, 4, 3, 2, 1 }, new int[] { 5, 4, 3, 2, 1 }),
      new TestCaseArray(new int[] { 6, 5, 4, 3, 2, 1 }, new int[] { 6, 5, 4, 3, 2, 1 }),
      new TestCaseArray(new int[] { 7, 6, 5, 4, 3, 2, 1 }, new int[] { 7, 6, 5, 4, 3, 2, 1 }),
  ...
  public static void main(String[] args) {
    ...
    for (TestCaseArray testCase : TestCases) {
      ...
      int[] result = buildMaxHeap(testCase.A);
  ...
  public static void heapify(int[] A, int n, int i) {
    ...
    if (left < n && A[left] > A[largest]) { // <--- changed here
      largest = left;
    }

    // If right child is smaller than smallest so far
    if (right < n && A[right] > A[largest]) { // <--- changed here
      largest = right;
    }
